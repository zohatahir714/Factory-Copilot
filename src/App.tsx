...
const MainLayout: React.FC = () => {
  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-[100dvh] w-full font-sans text-slate-900 dark:text-slate-100 transition-colors duration-200 selection:bg-indigo-600 selection:text-white">
        <LoginScreen />
      </div>
    );
  }
  ...
  return (
    <div className="flex h-[100dvh] w-full overflow-hidden font-sans text-slate-900 dark:text-slate-100 transition-colors duration-200 selection:bg-indigo-600 selection:text-white">
